 ...
 * @property string $id
 * @property string $MakelaarId
 * @property string $MakelaarNaam
 * @property string $update_time
 *
 * The followings are the available model relations:
 * @property FundaPage[] $fundaPages
...
class Agent extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('MakelaarId', 'required'),
			array('MakelaarId', 'length', 'max'=>10),
			array('MakelaarNaam', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, MakelaarId, MakelaarNaam, update_time', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'realties' => array(self::HAS_MANY, 'Realty', 'agent_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('MakelaarId',$this->MakelaarId,true);
